...
* The original package name 'com.laborwaze.queue-system' is invalid and this project uses 'com.laborwaze.queue_system' instead.
...
* [WebSocket](https://docs.spring.io/spring-boot/3.5.13/reference/messaging/websockets.html)
...
* [Java Mail Sender](https://docs.spring.io/spring-boot/3.5.13/reference/io/email.html)
